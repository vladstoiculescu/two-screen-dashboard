  ...
  return (
    <Card className="bg-slate-800/40 border-slate-700 text-white">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg font-medium">UNPLACED ORDERS</CardTitle>
            ...
            <div key={order.id} className="flex items-center justify-between border-b border-slate-700 pb-4">
              <div className="flex items-center gap-4">
                <div className="bg-slate-700 p-2 rounded-md">
                  {order.name === 'Oceanul Indian' || order.name === 'Hanu Berarilor' ? (
                  ...
                  ) : order.name === 'BRIO' || order.name === 'Click' ? (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  ...
                  <div className="text-red-400 text-xs">Forecast: {order.forecast}</div>
                  <div className="text-gray-400 text-xs">Last Order: {order.lastOrder}</div>
                  <div className="text-gray-400 text-xs">Frequency: {order.frequency}</div>
                </div>
              </div>
